...
{{< figure src="/images/solitary-island-1.png" title="Now that you have a choice to go" >}}
{{< figure src="/images/solitary-island-2.png" title="Initial Solitary Island Map" >}}
...
## Solitary Island 00: Poem

{{< figure src="/images/solitary-island-lv00.png" >}}

**難易度**: ☆☆

{{< admonition type=tip title="提示 💡" open=false >}}
The space to the left of "Violet" looks empty.
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv01.png" >}}
...
{{< admonition type=tip title="提示 💡" open=false >}}
This level looks almost exactly like the opening level. Should it be completed the same way?
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv02.png" >}}

**難易度**: ☆☆

{{< admonition type=tip title="提示 💡" open=false >}}
You can't change Skull is Float. How can Baba pass by?
{{< /admonition >}}

{{< admonition type=tip title="提示 💡💡" open=false >}}
If Baba is Float and Water is not, you can cross. Is there another way to cross?
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv03.png" >}}
...
{{< admonition type=tip title="提示 💡" open=false >}}
What is preventing you from getting the top rock out of the corner?
{{< /admonition >}}

{{< admonition type=tip title="提示 💡💡" open=false >}}
Does "Push" provide you with any use?
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv04.png" >}}
...
{{< admonition type=tip title="提示 💡" open=false >}}
There are two changes to this level. What are they?
{{< /admonition >}}

{{< admonition type=tip title="提示 💡💡" open=false >}}
One change is the placement of the rocks, yes. What is the other one? Has one of the rules changed? If so, that means the rule from the previous level does not apply.
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv05.png" >}}
...
{{< admonition type=tip title="提示 💡" open=false >}}
How many objects do you have access to that you can Sink in the Water?
{{< /admonition >}}

{{< admonition type=tip title="提示 💡💡" open=false >}}
You can't change the rules at the top of the screen. Why do you have access to them?
{{< /admonition >}}
...
{{< figure src="/images/solitary-island-lv06.png" >}}

**難易度**: ☆

**新物件**：noun **Robot** and **Pipe**. Should be obvious which is which.

{{< admonition type=tip title="提示 💡" open=false >}}
Why is "Baba" on your side of the river?
{{< /admonition >}}
